...
for xd in range(1000):
	...
	f='/11.0.077; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/537.36(KHTML, like Gecko) Safari/'
...
for jiah in range(1000):
	aa='Mozilla/5.0 (Linux; Android 8.1.0; Redmi 5A Build/OPM1.171019.026; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/92.0.4515.166 Mobile Safari/537.36'
	b=random.choice(['6','7','8','9','10','11','12'])
	c='Quad-core Max 1.40GHz
...
#	g='AppleWebKit/537.36 (KHTML, like Gecko) Mobile/'
	...
	l='[FBAN/FBIOS;FBAV/96.0.0.45.70;FBBV/60548545;FBDV/iPhone7,2;FBMD/Redmi 5a;FBSN/Android;FBSV/10.3.2;FBSS/2;FBCR/E-Plus;FBID/phone;FBLC/de_DE;FBOP/5;FBRV/0]'
...
#	pil=input('[•] Choose : ')
	...
	if pil in ['1','01']:
		...
		try:
			...
			sol().print(cik2)
			cookie=input("[•] Cookie : ")
			headers = {'User-Agent':'Mozilla/5.0 (Linux; Android 8.1.0; Redmi 5A Build/OPM1.171019.026; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/92.0.4515.166 Mobile Safari/537.36'}
			ses=requests.Session()
...
def tCookie():
	banner()
	wel='# COOKIE IS NOT APPLICABLE OR WRONG'
	wel2 = mark(wel, style='red')
	sol().print(wel2)
	time.sleep(2)
	Cokie=input('[•] Enter License : ')
...
def lisensi():
	try:
		cek=open('.Cookie.txt').read()
		Cookie.append(cek)
	except:
		tCookie()
	ses=requests.Session()
	res=requests.get('https://app.cryptolens.io/api/key/Activate?token&ProductId=15479&Key='+lisensikuni[0]).json()
	status=res['licenseKey']['Cokie']
	if status ==cek:
		banner()
		wel='# COOKIE APPLICABLE '
		wel2 = mark(wel, style='cyan')
		sol().print(wel2)
		time.sleep(2)
		lisensiku.append("Tidak")
	else:
		tlisensi()
	anoun()
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (Linux; Android 8.1.0; Redmi 5A Build/OPM1.171019.026; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/92.0.4515.166 Mobile Safari/537.36'
